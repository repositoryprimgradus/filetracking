...
"1935"])),c=a?this.oK():"",$.Fe(this.i,{href:a?this.qK():"#",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.Fe(this.b,{alt:a?this.pK():"AnyChart - JavaScript Charts"}),this.I(nl));this.J(ol)&&(a=a?this.text():" ",$.ef(this.D,a),this.I(ol));if(this.J(pl)){if(a=tl(this)?this.zF():rl()){if(this.P=a,b=vh($.ng()))$.Ld(b,"complete",this.p4,!1,
